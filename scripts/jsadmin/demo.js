...
$(function () {
  ...
  function get(name) {
    if (typeof (Storage) !== 'undefined') {
      ...
      window.alert('Utilice un navegador moderno para ver correctamente esta pagina!')
    }
  }
  ...
  $demoSettings.append('<h4 class="control-sidebar-heading">Diseño de la pagina</h4>')
