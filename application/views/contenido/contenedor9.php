   ...
   <div id="container-div-actualizar">
    ...
    <form id="formactualizar" class="form-horizontal" method="POST" action="<?php base_url();?>principal/modificardatospersonales" autocomplete="off">
    <fieldset>
    <legend class="text-center header">Modificando mis datos 
    <button type="button" class="close" aria-label="Close" id="cerradatos">
    ...
    <p style="text-align: left; font-size:1.1em;"><strong>Nota:</strong> Si hay un error en sus datos por favor informarlo al administrador de la pagina para corregir</p>
    <button type="button" class="btn btn-secondary btn-lg" id="cancelar-info">Cancelar</button>
