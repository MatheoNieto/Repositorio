      ...
      <html>
          ...
          <body onload="nobackbutton()">
            <div id="fondo">
        <img src="<?php echo base_url(); ?>css/images/fondos/<?php foreach ($usuarios as $user){ echo $user->imgfondo; } ?>" id="imgfondo"  alt="Cargando....." width="100%" height="100%">
    </div>
      <div id="contenedor-viewdocument" class="animated zoomInUp">
                <div class="row"> <a  id="btn-atras2" style="margin-left:20px; cursor:pointer;"><img src="<?php echo base_url(); ?>css/images/flecha-atras.png"  alt="" class="fa fa-user bigicon"></a></div>
<br>
 <div class="embed-container">
    <iframe width="560" height="315" src="<?php echo base_url(); ?>css/adjuntos/<?php foreach ($mostraradjunto as $adjuntom){ echo $adjuntom->adjunto; } ?>" frameborder="0" allowfullscreen></iframe>
</div>
<div id="menucomentarios">
    <button type="button" class="btn btn-info btn-sm" id="btncomentarios">
          <span id="span" class="glyphicon glyphicon-arrow-left"></span>
        </button>
        <form id="formcomentarios" class="form-horizontal" method="POST" action="<?php base_url();?>hacercomentario" autocomplete="off" >
                <fieldset>
...
<div class="media">
    ...
    <input type="text" value="<?php foreach ($mostraradjunto as $madjunto){ echo $madjunto->id; } ?>" style="display:none;" name="txtidadjunto" id="txtidadjunto">
